...
export default function HeroSection() {
  ...
  return (
    <section
      id="hero"
      className="carbon-bg relative min-h-screen overflow-hidden"
    ...
    >
      ...
      <div
        ...
        style={{
          background:
            "linear-gradient(to bottom, #fb923c, #f97316, #c04400, #f97316, #fb923c)",
        }}
      />
      ...
      <div className="relative max-w-7xl mx-auto px-8 sm:px-12 lg:px-16 w-full pt-20 grid grid-cols-1 lg:grid-cols-2 gap-4 min-h-screen items-center">
        ...
        <div className="flex flex-col justify-center py-16 lg:py-0">
          ...
          <div className="fade-up mb-8">
            <div className="metal-badge inline-flex items-center gap-2.5 rounded-full px-5 py-2.5">
              <div
                ...
                style={{
                  background:
                    "radial-gradient(circle, #fb923c 0%, #f97316 60%)",
                  boxShadow:
                    "0 0 8px rgba(249,115,22,0.9), 0 0 16px rgba(249,115,22,0.4)",
                }}
              />
          ...
          <div
            ...
            style={{
              background:
                "linear-gradient(to right, #f97316, rgba(249,115,22,0.3), transparent)",
            }}
          />

          {/* Subtext */}
          <p className="fade-up fade-up-d2 text-[#707070] text-sm sm:text-base max-w-xs leading-relaxed mb-8">
            Experience the perfect blend of quality, durability and expert
            guidance — cycles built for every rider.
          </p>
        ...
        <div className="relative flex items-center justify-center min-h-[420px] lg:min-h-screen py-8 lg:py-0">
          ...
          <div
            ...
            style={{
              ...
              height: "65%",
              background:
                "radial-gradient(circle, rgba(249,115,22,0.07) 0%, transparent 68%)",
            }}
          />
          ...
          <img
            ...
            className="relative z-10 w-full max-w-md lg:max-w-xl object-contain select-none"
            style={{
              filter:
          ...
          <div className="embossed-card absolute top-12 lg:top-24 right-0 sm:right-2 rounded-xl px-4 py-3 flex items-center gap-3 z-20">
            <div
              className="w-8 h-8 rounded-lg flex items-center justify-center flex-shrink-0"
              style={{
                background: "linear-gradient(145deg, #2a1200, #1a0c00)",
                boxShadow:
                  "inset 0 1px 0 rgba(249,115,22,0.25), 0 0 8px rgba(249,115,22,0.2)",
            ...
            <div>
              <div className="text-[#777] text-[10px] font-semibold uppercase tracking-wider">
                Call Us Now
              </div>
              <a
                href={PHONE_LINK}
